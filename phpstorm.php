 ...
 * @property Ajax                $ajax                                Ajax controller
 * @property Child               $child                               Child controller
 * @property Ajax                $main                                Main controller
 * @property Test                $test                                Test controller
 */
class CI_Controller {
 ...
 * @property CI_Zip              $zip                                 Zip Compression Class
 * @property CI_Utf8             $utf8                                Provides support for UTF-8 environments
 * @property Classe_model        $classe                              Provide database interaction with Classe table
 * @property Eleve_model         $eleve                               Provide database interaction with Eleve table
 * @property Emprunt_model       $emprunt                             Provide database interaction with Emprunt table
 * @property Livre_model         $livre                               Provide database interaction with Livre table
 * @property Personnel_model     $person                              Provide database interaction with Personnel table
 * @property Theme_model         $theme                              Provide database interaction with Theme table
 * @property Utilisateur_model   $user                              Provide database interaction with Classe table
 */
class CI_Model {
